...
public class Vector2DTest {
	...
	public void testDotProduct() {
		assertEquals("v1 and v3 are orthogonal. The dot product should be zero.", 0.0, v1.dotProduct(v3),0.0);
		assertEquals("The dot product of v1 and v2 should be (-2 * 1) + (4 * 2) = 6", 6.0, v1.dotProduct(v2),0.0);
	}
