...
public class Money implements Comparable {
	 ...
	 */
	public Money negate() {
		return new Money(Integer.parseInt(String.valueOf(this.amount * -1)),this.currency);
	}
	...
	public int compareTo(Object other) {
		return Integer.compare(
			(int) (this.amount * this.currency.getRate()),
			(int) (((Money) other).amount * ((Money) other).currency.getRate())
		);
	}
}